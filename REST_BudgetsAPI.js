...
(function process(request, response) {
  ...
  if (method === 'GET') {
    var gr = new GlideRecord('x_pfmt_budget');
  ...
  if (method === 'POST') {
    ...
    var dupGR = new GlideRecord('x_pfmt_budget');
    ...
    var newGR = new GlideRecord('x_pfmt_budget');
    newGR.initialize();
  ...
  if (method === 'PUT') {
    ...
    var editGR = new GlideRecord('x_pfmt_budget');
  ...
  if (method === 'DELETE') {
    ...
    var delGR = new GlideRecord('x_pfmt_budget');
