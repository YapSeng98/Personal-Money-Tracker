...
(function process(request, response) {
  ...
  // ── GET /accounts ─────────────────────────────────────────
  if (method === 'GET') {
    var gr = new GlideRecord('x_pfmt_account');
  ...
  if (method === 'POST') {
    ...
    var dupGR = new GlideRecord('x_pfmt_account');
    ...
    var newGR = new GlideRecord('x_pfmt_account');
    newGR.initialize();
  ...
  if (method === 'PUT') {
    ...
    var editGR = new GlideRecord('x_pfmt_account');
  ...
  if (method === 'DELETE') {
    ...
    var delGR = new GlideRecord('x_pfmt_account');
